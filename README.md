...
```bash
git clone https://github.com/jennings/jj-spr.git
cd jj-spr
...
Full documentation is available at **[jennings.github.io/jj-spr](https://jennings.github.io/jj-spr/)**

Quick links:
- [Installation](https://jennings.github.io/jj-spr/user/installation.html) - Detailed installation instructions
- [Setup](https://jennings.github.io/jj-spr/user/setup.html) - Initial configuration
- [Simple PR Workflow](https://jennings.github.io/jj-spr/user/simple.html) - Single PR workflow guide
- [Stacked PRs](https://jennings.github.io/jj-spr/user/stack.html) - Multi-PR workflows and stacking
- [Commit Messages](https://jennings.github.io/jj-spr/user/commit-message.html) - Message format and sections
- [Commands Reference](https://jennings.github.io/jj-spr/reference/commands.html) - Complete command reference
- [Configuration](https://jennings.github.io/jj-spr/reference/configuration.html) - All configuration options
